...
#### Demo mode
During summary generation, per default (TESTING = True) the results within the file "example.json" are used. You can change that behaviour and use a defined model to generate the summary by setting this variable to false.
